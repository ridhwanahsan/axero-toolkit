<?php
    ...
    class lunex_price_table extends Widget_Base
    {

        public function get_name()
        {
            return 'lunex_price_table';
        }

        public function get_title()
        {
            return __('Price Table', 'lunex-toolkit');
        }
        ...
        protected function register_controls_section()
        {
            ...
            $this->start_controls_section(
                'price_ction',
                [
                    'label' => esc_html__('Price Table', 'lunex-toolkit'),
                    'tab'   => Controls_Manager::TAB_CONTENT,
                    'condition' => [
            ...
            $repeater->add_control(
                'plan_title',
                [
                    'label' => esc_html__('Plan Title', 'lunex-toolkit'),
                    'type' => Controls_Manager::TEXT,
                    'default' => 'Starter',
                ]
            );
            ...
            $repeater->add_control(
                'plan_price',
                [
                    'label' => esc_html__('Price', 'lunex-toolkit'),
                    'type' => Controls_Manager::TEXT,
                    'default' => '$999',
                ]
            );
            ...
            $repeater->add_control(
                'plan_price_suffix',
                [
                    'label' => esc_html__('Price Suffix', 'lunex-toolkit'),
                    'type' => Controls_Manager::TEXT,
                    'default' => '/month',
                ]
            );
            ...
            $this->add_control(
                'plans',
                [
                    'label' => esc_html__('Plans', 'lunex-toolkit'),
            ...
            $feature_repeater->add_control(
                'feature_title',
                [
                    'label' => esc_html__('Feature Title', 'lunex-toolkit'),
                    'type' => Controls_Manager::TEXT,
            ...
            $feature_repeater->add_control(
                'feature_values',
                [
                    'label' => esc_html__('Feature Values (per plan)', 'lunex-toolkit'),
                    'type' => Controls_Manager::TEXTAREA,
                    'description' => esc_html__('Comma separated values for each plan (e.g. check,check,close,check)', 'lunex-toolkit'),
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Price Table (Style 2)', 'lunex-toolkit'),
                    'tab'   => Controls_Manager::TAB_CONTENT,
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Discount Text', 'lunex-toolkit'),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => true,
            ...
            $monthly_plan_repeater->add_control(
                ...
                [
                    'label' => esc_html__('Features', 'lunex-toolkit'),
                    'type' => Controls_Manager::TEXTAREA,
                    'description' => esc_html__('One feature per line', 'lunex-toolkit'),
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Monthly Plans', 'lunex-toolkit'),
                    'type' => Controls_Manager::REPEATER,
            ...
            $this->add_control(
                'style2_yearly_plans',
                [
                    'label' => esc_html__('Yearly Plans', 'lunex-toolkit'),
                    'type' => Controls_Manager::REPEATER,
            ...
            $features_table_repeater->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::TEXT,
                    'label_block' => true,
                    'description' => esc_html__('Comma separated values for each plan (e.g. check,check,close)', 'lunex-toolkit'),
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Features Table', 'lunex-toolkit'),
                    'type' => Controls_Manager::REPEATER,
        ...
        $this->start_controls_section(
            'book_button_style',
            [
                'label' => esc_html__('Book Button Style', 'lunex-toolkit'),
        ...
        $this->start_controls_section(
            ...
            [
            'label' => esc_html__('Price Table Style', 'lunex-toolkit'),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
                'style_selection' => 'style1'
            ],
        ...
        $this->add_control(
            'table_border_color',
            [
            'label' => esc_html__('Table Border Color', 'lunex-toolkit'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            'table_head_bg_color',
            [
            'label' => esc_html__('Header Background Color', 'lunex-toolkit'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            ...
            [
            'label' => esc_html__('Header Text Color', 'lunex-toolkit'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            'plan_price_color',
            [
            'label' => esc_html__('Plan Price Color', 'lunex-toolkit'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            ...
            [
            'label' => esc_html__('Plan Price Suffix Color', 'lunex-toolkit'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            'plan_button_heading',
            [
            'label' => esc_html__('Plan Button', 'lunex-toolkit'),
        ...
        $this->add_control(
            ...
            [
            'label' => esc_html__('Button Background', 'lunex-toolkit'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            ...
            [
            'label' => esc_html__('Button Border Radius', 'lunex-toolkit'),
        ...
        $this->add_control(
            'feature_row_heading',
            [
            'label' => esc_html__('Feature Row', 'lunex-toolkit'),
            'type' => Controls_Manager::HEADING,
            'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
            'label' => esc_html__('Row Background Color', 'lunex-toolkit'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            ...
            [
            'label' => esc_html__('Row Text Color', 'lunex-toolkit'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            'icon_check_color',
            [
            'label' => esc_html__('Check Icon Color', 'lunex-toolkit'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control(
            'icon_close_color',
            [
            'label' => esc_html__('Close Icon Color', 'lunex-toolkit'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Tab Switcher Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Active/Hover Tab Style', 'lunex-toolkit'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Box Title Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Price Description Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->start_controls_section(
            'style2_price_style',
            [
                'label' => esc_html__('Price Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Features List Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Dot Background Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Price Button Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Normal State', 'lunex-toolkit'),
                'type' => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Hover State', 'lunex-toolkit'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
...
<div class="pricing-area ">
        ...
        <div class="pricing-area pt-80 pb-150"> 
            ...
            <div class="pricing-tabs" data-cue="slideInUp">
                ...
                <li class="nav-item d-inline-block" role="presentation">
                    ...
                    <?php echo esc_html__('Monthly', 'lunex-toolkit'); ?>
                    </button>
                </li>
                <li class="nav-item d-inline-block" role="presentation">
                    ...
                    <?php echo esc_html__('Yearly', 'lunex-toolkit'); ?>
                    </button>
                </li>
                </ul>
    ...
    $widgets_manager->register(new lunex_price_table());