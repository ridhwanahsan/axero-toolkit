<?php
    ...
    class Lunex_Post_Grid_slider extends Widget_Base
    {

        public function get_name()
        {
            return 'Lunex-Post-grid';
        }

        public function get_title()
        {
            return __('Blog Grid', 'lunex-toolkit');
        }
        ...
        $this->start_controls_section(
            'style1_date_style',
            [
                'label' => esc_html__('Date Style', 'lunex-toolkit'),
        ...
        $this->start_controls_section(
            'style6_author_style',
            [
                'label' => esc_html__('Author Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style6',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Normal Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Link Button Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => ['style1', 'style2', 'style6'],
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Hover Background Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style 3 Meta Text', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style 3 Title Text', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style3',
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style 3 Description Text', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style3',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Normal Border Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Hover Border Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Reading Time Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style5',
                ],
                    ...
                    <div class="single-blog-post">
                        ...
                        <div class="content">
                            ...
                            <a href="<?php the_permalink(); ?>" class="link-btn d-flex align-items-center position-relative">
                                <?php echo esc_html__('Read More', 'lunex-toolkit'); ?>
...
$widgets_manager->register(new Lunex_Post_Grid_slider());