<?php
    ...
    class lunex_faq_according  extends Widget_Base
    {

        public function get_name()
        {
            return 'lunex_faq_according ';
        }

        public function get_title()
        {
            return __('FAQ', 'lunex-toolkit');
        }
        ...
        $this->start_controls_section(
            'faq_content',
            [
                'label' => esc_html__('FAQ Items', 'lunex-toolkit'),
                'tab'   => Controls_Manager::TAB_CONTENT,
                'condition' => [
        ...
        $this->add_control(
            'first_item_open',
            [
                'label'        => esc_html__('First Item Open', 'lunex-toolkit'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__('Yes', 'lunex-toolkit'),
                'label_off'    => esc_html__('No', 'lunex-toolkit'),
                'return_value' => 'yes',
                'default'      => 'no',
                'description'  => esc_html__('Make the first FAQ item open by default', 'lunex-toolkit'),
            ]
        );
        ...
        $repeater->add_control(
            'faq_question',
            [
                'label'       => esc_html__('Question', 'lunex-toolkit'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('What services do you offer?', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'faq_answer',
            [
                'label'      => esc_html__('Answer', 'lunex-toolkit'),
                'type'       => Controls_Manager::WYSIWYG,
                'default'    => esc_html__('We offer a wide range of services...', 'lunex-toolkit'),
                'show_label' => false,
            ]
        );
        ...
        $repeater->add_control(
            'faq_default_open',
            [
                'label'        => esc_html__('Open by Default', 'lunex-toolkit'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__('Yes', 'lunex-toolkit'),
                'label_off'    => esc_html__('No', 'lunex-toolkit'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'faq_question' => esc_html__('What services do you offer?', 'lunex-toolkit'),
                        'faq_answer'   => esc_html__('We offer a wide range of services...', 'lunex-toolkit'),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'style2_faq_question' => esc_html__('What services do you offer?', 'lunex-toolkit'),
                        'style2_faq_answer'   => esc_html__('We offer a wide range of services...', 'lunex-toolkit'),
                    ],
                    [
                        'style2_faq_question' => esc_html__('How can we help your business?', 'lunex-toolkit'),
                        'style2_faq_answer'   => esc_html__('We provide innovative solutions to grow your business...', 'lunex-toolkit'),
                    ],
                ],
        ...
        $style3_repeater->add_control(
            ...
            [
                'label' => esc_html__('Question', 'lunex-toolkit'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Expertise Teams', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $style3_repeater->add_control(
            ...
            [
                'label' => esc_html__('Answer', 'lunex-toolkit'),
                'type' => Controls_Manager::WYSIWYG,
                'default' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit...', 'lunex-toolkit'),
                'show_label' => false,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'style3_faq_question' => esc_html__('Expertise Teams', 'lunex-toolkit'),
                        'style3_faq_answer' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit...', 'lunex-toolkit'),
                    ],
                    [
                        'style3_faq_question' => esc_html__('Quality Services', 'lunex-toolkit'),
                        'style3_faq_answer' => esc_html__('Sed do eiusmod tempor incididunt ut labore et dolore magna...', 'lunex-toolkit'),
                    ],
                ],
        ...
        $this->add_control(
            'number_color',
            [
            'label'     => esc_html__('Number Show Color', 'lunex-toolkit'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                // Default (open) state
        ...
        $this->add_control(
            ...
            [
            'label'     => esc_html__('Number Collapsed Color', 'lunex-toolkit'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                // Collapsed state
        ...
        $this->add_control(
            'number_bg_color',
            [
            'label'     => esc_html__('collapse Number show Background Color  ', 'lunex-toolkit'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                // Default (open) state
        ...
        $this->add_control(
            ...
            [
            'label'     => esc_html__('Collapsed Number Background Color', 'lunex-toolkit'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                // Collapsed state
        ...
        $this->add_control(
            'number_border_color',
            [
                'label'     => esc_html__('Number Border Color', 'lunex-toolkit'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'number_border_width',
            [
                'label'     => esc_html__('Number Border Width', 'lunex-toolkit'),
        ...
        $this->add_control(
            'number_border_style',
            [
                'label'     => esc_html__('Number Border Style', 'lunex-toolkit'),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    ...
                    'double' => esc_html__('Double', 'lunex-toolkit'),
                ],
                'default'   => 'solid',
                'selectors' => [
        ...
        $this->add_control(
            'question_heading',
            [
                'label' => esc_html__('Question Style', 'lunex-toolkit'),
        ...
        $this->add_control(
            'answer_heading',
            [
                'label' => esc_html__('Answer Style', 'lunex-toolkit'),
                'type'  => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Collapsed Icon Color', 'lunex-toolkit'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style 3 Question', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style3',
                ],
        ...
        $this->add_control(
            'style3_answer_color',
            [
                'label' => esc_html__('Answer Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    $widgets_manager->register(new lunex_faq_according ());