<?php
    ...
    class axero_banner_1 extends Widget_Base
    {
        ...
        <!-- style 3 -->
         <div class="banner_wrapper_area pb-150 position-relative z-1 overflow-hidden">
            <div class="container-fluid">
        ...
        <!-- style 4 -->
            <div class="career-page-banner-area">
                <div class="container">
                    <div class="row align-items-center" data-cues="slideInUp">
                        <div class="col-lg-6 col-md-12">
                            <div class="content">
                                <?php if ( !empty($settings['style4_subtitle']) ) : ?>
                                    <span class="sub-title d-block">
                                        <?php echo wp_kses_post($settings['style4_subtitle']); ?>
                                    </span>
                                <?php endif; ?>
                                <?php if ( !empty($settings['style4_main_title']) ) : ?>
                                    <h1>
                                        <?php echo wp_kses_post($settings['style4_main_title']); ?>
                                    </h1>
                                <?php endif; ?>
                                <div class="funfacts d-md-flex align-items-center justify-content-between">
                                    <?php if ( !empty($settings['style4_items']) && is_array($settings['style4_items']) ) : ?>
                                        <?php foreach ( $settings['style4_items'] as $item ) : ?>
                                            <div class="funfact position-relative">
                                                <?php if ( !empty($item['style4_number']) ) : ?>
                                                    <div class="number lh-1">
                                                        <?php echo wp_kses_post($item['style4_number']); ?>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if ( !empty($item['style4_title']) ) : ?>
                                                    <span class="d-block">
                                                        <?php echo wp_kses_post($item['style4_title']); ?>
                                                    </span>
                                                <?php endif; ?>
                                            </div>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                    <?php if ( !empty($settings['style4_content']) ) : ?>
                                        <p>
                                            <?php echo wp_kses_post($settings['style4_content']); ?>
                                        </p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="image">
                                <?php if ( !empty($settings['style4_image']['url']) ) : ?>
                                    <img src="<?php echo esc_url($settings['style4_image']['url']); ?>" alt="<?php echo esc_attr(basename($settings['style4_image']['url'])); ?>">
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
