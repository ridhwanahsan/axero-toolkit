<?php
    ...
    class Axero_service_post extends Widget_Base
    {
        ...
        {
            return __('Service post', 'axero-toolkit');
        }
        ...
        protected function style_tab_content()
        {
            ...
            $this->add_control(
                'excerpt_color',
                [
                    'label'     => esc_html__('Excerpt Color', 'axero-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 5 Service Style', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => esc_html__('Content Typography', 'axero-toolkit'),
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => esc_html__('Button Typography', 'axero-toolkit'),
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Active/Hover Styles', 'axero-toolkit'),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            ...
            $this->start_controls_section(
                'style2_number_style',
                [
                    'label'     => esc_html__('Style 2 Number Style', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 2 Line Background', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style2',
                    ],
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 3 Item Background', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 3 Link Button', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style3',
                    ],
            ...
            $this->start_controls_section(
                'style3_title_style',
                [
                    'label'     => esc_html__('Style 3 Title', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style3',
                    ],
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 3 Description', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style3',
                    ],
