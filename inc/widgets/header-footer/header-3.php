<?php
    ...
    class axero_header_three extends Widget_Base
    {
        ...
        {
            return __('Header 3', 'axero-toolkit');
        }
        ...
        protected function style_tab_content()
        {
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => ['px', '%', 'em'],
                    'selectors' => [
                        '{{WRAPPER}} .white_btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            $this->end_controls_section();
        ...
        protected function render() 
        {
            $settings = $this->get_settings_for_display(); ?>
                <div class="navbar_area <?php echo esc_attr($settings['header_style_type']); ?> top-0 start-0 end-0 h-auto  border_bottom">
