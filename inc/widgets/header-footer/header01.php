<?php
    ...
    class axero_header_one extends Widget_Base
    {
        ...
        {
            return __('Header one', 'axero-toolkit');
        }
        ...
        protected function style_tab_content()
        {
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Dropdown Arrow Color', 'axero-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Dropdown Arrow Hover Color', 'axero-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Submenu Hover Background', 'axero-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Submenu Hover Color', 'axero-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Icon Background Hover Color', 'axero-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
