<?php
    ...
    class lunex_header_four extends Widget_Base
    {

        public function get_name()
        {
            return 'lunex_header_four';
        }

        public function get_title()
        {
            return __('Header Four', 'lunex-toolkit');
        }
        ...
        $this->add_control(
            'menu_text',
            [
                'label' => esc_html__('Menu Text', 'lunex-toolkit'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Menu', 'lunex-toolkit'),
                'description' => esc_html__('Text to display next to menu icon', 'lunex-toolkit'),
            ]
        );
        $this->add_control(
            'menu_icon',
            [
                ...
                'description' => esc_html__('Upload the menu icon image', 'lunex-toolkit'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
...
$this->add_control(
    ...
    [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Toggle Menu Text Color', 'lunex-toolkit'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Toggle Menu Text Hover Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Toggle Menu Text Typography', 'lunex-toolkit'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Button Text Hover Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Button Text Typography', 'lunex-toolkit'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Close Button Size', 'lunex-toolkit'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Email Hover Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
 ...
 <div class="navbar-area style-three top-0 start-0 end-0 h-auto">
                ...
                <div class="navbar-popup-menu">
                    ...
                    if (!empty($settings['mobile_selected_menu'])) {
                        if (class_exists('\header_four_nav_walker')) {
                            ...
                            echo '<div class="alert alert-warning">Lunex Toolkit plugin is not active. Please activate it for full functionality.</div>';
                        }
                    }
                    ?>
                    <div class="info">
    ...
    $widgets_manager->register(new lunex_header_four()); 