<?php
    ...
    class lunex_header_three extends Widget_Base
    {

        public function get_name()
        {
            return 'lunex_header_three';
        }

        public function get_title()
        {
            return __('Header Three', 'lunex-toolkit');
        }
        ...
        $this->start_controls_section(
            'menu_selection',
            [
                'label' => esc_html__('Header Setting', 'lunex-toolkit'),
                'tab'   => Controls_Manager::TAB_CONTENT,
                'condition' => [
...
$this->add_control(
    ...
    [
        ...
        $this->start_controls_section(
            'header_nav_style',
            [
                'label' => esc_html__('Header Style Setting', 'lunex-toolkit'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Toggle Icon Background', 'lunex-toolkit'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Toggle Icon Hover Background', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'menu_icon',
            [
                'label' => esc_html__('Menu Icon', 'lunex-toolkit'),
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => get_template_directory_uri() . '/assets/images/icons/menu.svg',
                ],
                'description' => esc_html__('Upload custom menu icon for navbar toggler', 'lunex-toolkit'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
  ...
  $this->add_responsive_control(
    ...
    [
        'label'     => esc_html__('Top Navigation Background', 'lunex-toolkit'),
        'type'      => Controls_Manager::COLOR,
        'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Top Navigation Padding', 'lunex-toolkit'),
...
<!------------------- Mobile device header One ---------------->
   <div class="menu-popup-area position-fixed start-0 end-0 top-0 bottom-0">
    ...
    $widgets_manager->register(new lunex_header_three()); 