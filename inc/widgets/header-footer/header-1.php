<?php
    ...
    class axero_header_one extends Widget_Base
    {

        public function get_name()
        {
            return 'axero_header_one';
        }

        public function get_title()
        {
            return __('Header 1', 'axero-toolkit');
        }
        ...
        protected function register_controls_section()
        {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => esc_html__('Lets Talk', 'axero-toolkit'),
                    'condition' => [
        ...
        protected function style_tab_content()
        {
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => ['px', '%', 'em'],
                    'selectors' => [
                        '{{WRAPPER}} .navbar_area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                    ],
                    'default' => [
                        'top' => '25',
                        'right' => '0',
            ...
            // Align navbar-nav (main menu)  
            $this->add_responsive_control(
                'navbar_nav_alignment',
                [
                    'label' => esc_html__('Menu Alignment', 'axero-toolkit'),
                    ...
                    'toggle' => false,
                    'selectors' => [
                        '{{WRAPPER}} .navbar-area .navbar .navbar-nav' => 'justify-content: {{SELECTOR}};',
                        '{{WRAPPER}} .navbar-area .navbar .navbar-nav' => '{{VALUE}}',
                    ],
                    'selectors_dictionary' => [
                        'start' => '',
                        'center' => 'margin-left: auto; margin-right: auto;',
                        'end' => 'margin-left: auto; margin-right: 40px;',
                    ],
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .navbar_area.style_three .navbar .navbar-nav .nav-item .nav-link' => 'color: {{VALUE}};',
                        '{{WRAPPER}} .navbar_area.style_three .navbar .navbar-nav .nav-item .dropdown-toggle::before' => 'color: {{VALUE}};',
                    ],
                ]
            );
...
$widgets_manager->register(new axero_header_one()); 