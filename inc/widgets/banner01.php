<?php
    ...
    class Axero_banner01 extends Widget_Base
    {

        public function get_name()
        {
            return 'axero-banner01';
        }

        public function get_title()
        {
            return __('Banner 01', 'axero-toolkit');
        }
        ...
        protected function register_controls_section()
        {
            ...
            $this->start_controls_section(
                'banner_content',
                [
                    'label' => esc_html__('Banner Content', 'axero-toolkit'),
                    'tab'   => Controls_Manager::TAB_CONTENT,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'     => esc_html__('The creative agency', 'axero-toolkit'),
                    'label_block' => true,
                ]
            );
            ...
            $this->add_control(
                'title_line1',
                [
                    'label'       => esc_html__('Title Line 1', 'axero-toolkit'),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__('Innovate. inspire', 'axero-toolkit'),
                    'label_block' => true,
                ]
            );
            ...
            $this->add_control(
                'title_line2',
                [
                    'label'       => esc_html__('Title Line 2', 'axero-toolkit'),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__('ignite growth', 'axero-toolkit'),
                    'label_block' => true,
                ]
            );
            ...
            $this->add_control(
                'banner_image',
                [
                    'label'   => esc_html__('Banner Image', 'axero-toolkit'),
            ...
            $this->add_control(
                'banner_image_alt',
                [
                    'label'       => esc_html__('Banner Image Alt Text', 'axero-toolkit'),
                    'type'        => Controls_Manager::TEXT,
            ...
            $this->add_control(
                'button_icon_alt',
                [
                    'label'       => esc_html__('Button Icon Alt Text', 'axero-toolkit'),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__('Chat Icon', 'axero-toolkit'),
                    'label_block' => true,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'     => esc_html__('At Axero, we blend creativity and strategy to create impactful brand experiences that inspire and drive growth. 🚀', 'axero-toolkit'),
                    'label_block' => true,
                ]
            );
            ...
            $repeater->add_control(
                'social_arrow_icon',
                [
                    'label'       => esc_html__('Arrow Icon', 'axero-toolkit'),
                    'type'        => Controls_Manager::MEDIA,
                    'default'     => [
                        'url' => '',
                    ],
                    ...
                    'description' => esc_html__('Upload SVG or image for arrow icon', 'axero-toolkit'),
                ]
            );
            ...
            $this->add_control(
                'social_items',
                [
                    'label'       => esc_html__('Social Items', 'axero-toolkit'),
                    'type'        => Controls_Manager::REPEATER,
                    'fields'      => $repeater->get_controls(),
                    'default'     => [
                        [
                            'social_text' => esc_html__('Instagram', 'axero-toolkit'),
                        ],
                        [
                            'social_text' => esc_html__('Twitter', 'axero-toolkit'),
                        ],
                        [
                            'social_text' => esc_html__('YouTube', 'axero-toolkit'),
                        ],
                    ],
        ...
        protected function style_tab_content()
        {
            ...
            $this->start_controls_section(
                'banner_style',
                [
                    'label' => esc_html__('Banner Style', 'axero-toolkit'),
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Circle Button', 'axero-toolkit'),
                    'tab'   => Controls_Manager::TAB_STYLE,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Text & Icon Hover Color', 'axero-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_responsive_control(
                'social_icon_spacing',
                [
                    'label'      => esc_html__('Icon Spacing', 'axero-toolkit'),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => ['px'],
                    'range'      => [
                        'px' => [
...
<?php echo esc_html($item['social_text']); ?>
                            ...
                            <?php if (! empty($item['social_arrow_icon']['url'])): ?>
                                <img src="<?php echo esc_url($item['social_arrow_icon']['url']); ?>" alt="<?php echo esc_attr__('Social arrow icon', 'axero-toolkit'); ?>">
                            <?php endif; ?>
...
$widgets_manager->register(new Axero_banner01());
