<?php
    ...
    class Lunex_career_Grid_slider extends Widget_Base
    {

        public function get_name()
        {
            return 'Lunex-career-grid';
        }

        public function get_title()
        {
            return __('Careers Grid', 'lunex-toolkit');
        }
        ...
        protected function register_controls_section()
        {
            ...
            $this->start_controls_section(
                'post_filter_section',
                [
                    'label' => esc_html__('career Filter', 'lunex-toolkit'),
                    'tab'   => Controls_Manager::TAB_CONTENT,
                ]
            );
            ...
            $this->add_control(
                'posts_per_page',
                [
                    'label'   => esc_html__('careers Per Page', 'lunex-toolkit'),
            ...
            $this->add_control(
                'exclude_posts',
                [
                    'label'       => esc_html__('Exclude careers', 'lunex-toolkit'),
        ...
        $this->start_controls_section(
            'style2_section',
            [
                'label' => esc_html__('Style 2', 'lunex-toolkit'),
        ...
        $this->start_controls_section(
            'style1_number_style',
            [
                'label' => esc_html__('Style 1 Number', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style1',
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style 1 Line Background', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style1',
                ],
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="awards-list" data-cues="slideInUp">
                        ...
                        if ($query->have_posts()) :
                            ...
                            <p><?php esc_html_e('No awards found.', 'lunex-toolkit'); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
$widgets_manager->register(new Lunex_career_Grid_slider());