<?php
    ...
    class Lunex_work_post extends Widget_Base
    {

        public function get_name()
        {
            return 'Lunex-work-post';
        }

        public function get_title()
        {
            return __('Work post', 'lunex-toolkit');
        }
        ...
        protected function register_controls_section()
        {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'style8' => esc_html__('Style 8', 'lunex-toolkit'),
                    ],
                ]
            );
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 5 Vector Image', 'lunex-toolkit'),
                    'tab'       => Controls_Manager::TAB_CONTENT,
                    'condition' => [
            ...
            $this->add_control(
                'style5_vector_image',
                [
                    'label'       => esc_html__('Vector Image', 'lunex-toolkit'),
                    'type'        => Controls_Manager::MEDIA,
                    'default'     => [
                        'url' => get_template_directory_uri() . '/assets/images/icons/vector2.svg',
                    ],
                    'description' => esc_html__('Upload or select a vector image to display in the style 5 layout', 'lunex-toolkit'),
                ]
            );
        ...
        protected function style_tab_content()
        {
            ...
            $this->start_controls_section(
                'style_tab_1',
                [
                    'label'     => esc_html__('Style Tab 1', 'lunex-toolkit'),
            ...
            $this->add_control(
                'link_icon_color',
                [
                    'label'     => esc_html__('Link Icon Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                'link_icon_bg_color',
                [
                    'label'     => esc_html__('Link Icon Background', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Link Icon Hover Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Link Icon Hover Background', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                'number_bg_color',
                [
                    'label'     => esc_html__('Number Background', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Number Hover Background', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Title Text Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Link Button Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Link Button Background Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                'style3_h3_color',
                [
                    'label'     => esc_html__('H3 Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('H3 Hover Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->start_controls_section(
                'style4_controls',
                [
                    'label'     => esc_html__('Style 4 Controls', 'lunex-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Read More Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Read More Hover Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Read More Icon Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Read More Icon Hover Background Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 5 Background', 'lunex-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style5',
                    ],
            ...
            $this->add_control(
                ...
                [
                    'label'      => esc_html__('Background Opacity', 'lunex-toolkit'),
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Blend Mode', 'lunex-toolkit'),
                    'type'      => Controls_Manager::SELECT,
                    'default'   => 'normal',
                    'options'   => [
                        'normal'   => esc_html__('Normal', 'lunex-toolkit'),
                        'multiply' => esc_html__('Multiply', 'lunex-toolkit'),
                        'screen'   => esc_html__('Screen', 'lunex-toolkit'),
                        'overlay'  => esc_html__('Overlay', 'lunex-toolkit'),
                        'darken'   => esc_html__('Darken', 'lunex-toolkit'),
                        'lighten'  => esc_html__('Lighten', 'lunex-toolkit'),
                    ],
                    'selectors' => [
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 5 Number & Title', 'lunex-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style5',
                    ],
    ...
    // Description Typography Control
            ...
            $this->start_controls_section(
                'style6_controls',
                [
                    'label'     => esc_html__('Style 6 Controls', 'lunex-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Details Button Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Details Button Background', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Details Button Hover Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Details Button Hover Background', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Sub Title Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => esc_html__('Sub Title Typography', 'lunex-toolkit'),
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label'    => esc_html__('Sub Title Border', 'lunex-toolkit'),
                    'selector' => '{{WRAPPER}} .case_study_box .content .sub_title',
                ]
            );
            $this->end_controls_section();
            ...
            $this->start_controls_section(
                'style7_section',
                [
                    'label'     => esc_html__('Style 7', 'lunex-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
            ...
            $this->start_controls_section(
                'style7_image_style',
                [
                    'label'     => esc_html__('Image Style (Style 7)', 'lunex-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style7',
                    ],
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 8 Image', 'lunex-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
            ...
            $this->add_responsive_control(
                'style8_image_width',
                [
                    'label'      => esc_html__('Image Width', 'lunex-toolkit'),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => ['px', '%'],
                    'range'      => [
                        'px' => [
            ...
            $this->add_responsive_control(
                'style8_image_height',
                [
                    'label'      => esc_html__('Image Height', 'lunex-toolkit'),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => ['px', '%'],
                    'range'      => [
                        'px' => [
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 8 Title', 'lunex-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style8',
                    ],
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 8 Description', 'lunex-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style8',
                    ],
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 8 Link Button', 'lunex-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style8',
                    ],
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Link Button Hover Color', 'lunex-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
        ...
        $this->start_controls_section(
            'style2_date_style',
            [
                'label' => esc_html__('Style 2 Date Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style 2 Link Button Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
	                            ...
	                            <div class="col-lg-7 col-md-12">
	                                <div class="content position-relative">
	                                    ...
	                                    <a href="<?php the_permalink(); ?>" class="link-btn d-flex align-items-center fw-medium">
	                                        <?php esc_html_e('Read More', 'lunex-toolkit'); ?> <i class="ri-arrow-right-up-line"></i>
	                                    </a>
	                                </div>
	                            </div>
	                        </div>
		                         ...
		                         <div class="col-lg-6 col-md-6">
	                                 ...
	                                 <div class="content">
	                                     ...
	                                     <a href="<?php echo esc_url(get_permalink()); ?>" class="link-btn d-inline-block position-relative">
	                                         <?php esc_html_e('Read more', 'lunex-toolkit'); ?> <i class="ri-arrow-right-line"></i>
	                                     </a>
	                                 </div>
	                             </div>
	                         </div>
                    ...
                    <div class="image">
                        ...
                        <div class="text">
                            ...
                            <a href="<?php the_permalink(); ?>" class="link-btn d-flex align-items-center position-relative">
                                <?php esc_html_e('View Project', 'lunex-toolkit'); ?>
                                <i class="ri-arrow-right-line"></i>
                            </a>
                        </div>
                        <a href="<?php the_permalink(); ?>" class="position-absolute z-1 start-0 end-0 top-0 bottom-0"></a>
...
<?php
  ...
  $widgets_manager->register(new Lunex_work_post());