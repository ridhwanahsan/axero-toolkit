<?php
    ...
    class axero_partners_area_logo extends Widget_Base
    {

        public function get_name()
        {
            return 'axero_partners_area_logo';
        }

        public function get_title()
        {
            return __('Partner Area', 'axero-toolkit');
        }
...
$widgets_manager->register(new axero_partners_area_logo());