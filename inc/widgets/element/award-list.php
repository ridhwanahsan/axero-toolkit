<?php
    ...
    class lunex_award_list extends Widget_Base
    {

        public function get_name()
        {
            return 'lunex_award_list';
        }

        public function get_title()
        {
            return __('Awards List', 'lunex-toolkit');
        }
        ...
        $repeater->add_control(
            'year',
            [
                'label' => esc_html__('Year', 'lunex-toolkit'),
        ...
        $repeater->add_control(
            'light_image',
            [
                'label' => esc_html__('Light Image', 'lunex-toolkit'),
        ...
        $repeater->add_control(
            'dark_image',
            [
                'label' => esc_html__('Dark Image', 'lunex-toolkit'),
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => \Elementor\Utils::get_placeholder_image_src(),
                ],
        ...
        $repeater->add_control(
            'permalink',
            [
                'label' => esc_html__('Permalink', 'lunex-toolkit'),
        ...
        $this->add_control(
            'awards_list',
            [
                'label' => esc_html__('Awards List', 'lunex-toolkit'),
        ...
        $repeater2->add_control(
            'style2_award_title',
            [
            'label' => esc_html__('Award Title', 'lunex-toolkit'),
            'type' => Controls_Manager::TEXT,
        ...
        $repeater2->add_control(
            'style2_award_status',
            [
            'label' => esc_html__('Status', 'lunex-toolkit'),
            'type' => Controls_Manager::TEXT,
            'default' => 'Winner',
            'label_block' => true,
            ]
        ...
        $repeater2->add_control(
            ...
            [
            'label' => esc_html__('Organization', 'lunex-toolkit'),
            'type' => Controls_Manager::TEXT,
        ...
        $repeater2->add_control(
            ...
            [
            'label' => esc_html__('Link View Text', 'lunex-toolkit'),
            'type' => Controls_Manager::TEXT,
            'default' => esc_html__('View', 'lunex-toolkit'),
            'label_block' => true,
            ]
        );
        $repeater2->add_control(
        ...
        $this->add_control(
            ...
            [
            'label' => esc_html__('Recognitions List', 'lunex-toolkit'),
            'type' => Controls_Manager::REPEATER,
        ...
        $this->add_control(
            'year_text_heading',
            [
                'label' => esc_html__('Year Text', 'lunex-toolkit'),
        ...
        $this->add_control(
            'icon_box_heading',
            [
                'label' => esc_html__('Icon Box', 'lunex-toolkit'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'number_box_heading',
            [
                'label' => esc_html__('Number Box', 'lunex-toolkit'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'link_button_heading',
            [
                'label' => esc_html__('Link Button', 'lunex-toolkit'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->start_controls_section(
            'style2_award_style',
            [
                'label' => esc_html__('Style 2 Award Style', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title Two Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title Two Hover Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title Three Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title Three Hover Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Link Button Hover Background Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
...
equal to 'style1'. If the condition is true, it outputs HTML code for "style 1". */
    ...
    $widgets_manager->register(new lunex_award_list());