<?php
    ...
    class lunex_team_card extends Widget_Base
    {

        public function get_name()
        {
            return 'lunex_team_card';
        }

        public function get_title()
        {
            return __('Team Card', 'lunex-toolkit');
        }
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Megan Wilson', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Founder', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'social_profiles',
            [
                'label' => esc_html__('Social Profiles', 'lunex-toolkit'),
        ...
        $style2_repeater->add_control(
            ...
            [
                'label' => esc_html__('Name', 'lunex-toolkit'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Team Member', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $style2_repeater->add_control(
            ...
            [
                'label' => esc_html__('Position', 'lunex-toolkit'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Team Position', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $style2_repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => LUNEX_IMG . '/teams/placeholder.jpg',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'style2_member_name' => esc_html__('Megan Wilson', 'lunex-toolkit'),
                        'style2_member_position' => esc_html__('Founder', 'lunex-toolkit'),
                        'style2_member_description' => esc_html__('Lorem ipsum dolor sit amet, consectet adipis cing elit. Fusce varius faucibus massa.', 'lunex-toolkit'),
                        'style2_social_profiles' => [
                            [
                    ...
                    [
                        'style2_member_name' => esc_html__('Zylen Orion', 'lunex-toolkit'),
                        'style2_member_position' => esc_html__('Co-founder', 'lunex-toolkit'),
                        'style2_member_description' => esc_html__('Lorem ipsum dolor sit amet, consectet adipis cing elit. Fusce varius faucibus massa.', 'lunex-toolkit'),
                        'style2_social_profiles' => [
                            [
            ...
            [
                ...
                'default' => [
                    [
                        ...
                        'style1_member_position' => esc_html__('Founder', 'lunex-toolkit'),
                        'style1_member_name' => esc_html__('Megan Wilson', 'lunex-toolkit'),
                        'style1_social_profiles' => [
                            [
                    ...
                    [
                        ...
                        'style1_member_position' => esc_html__('Co-founder', 'lunex-toolkit'),
                        'style1_member_name' => esc_html__('Zylen Orion', 'lunex-toolkit'),
                        'style1_social_profiles' => [
                            [
                                'style1_social_icon' => ['value' => 'ri-facebook-fill', 'library' => 'ri'],
                                'style1_social_link' => ['url' => '#', 'is_external' => true, 'nofollow' => false],
                    ...
                    [
                        ...
                        'style1_member_position' => esc_html__('Manager', 'lunex-toolkit'),
                        'style1_member_name' => esc_html__('Veyron Lorien', 'lunex-toolkit'),
                        'style1_social_profiles' => [
                            [
                                'style1_social_icon' => ['value' => 'ri-facebook-fill', 'library' => 'ri'],
                                'style1_social_link' => ['url' => '#', 'is_external' => true, 'nofollow' => false],
                    ...
                    [
                        ...
                        'style1_member_position' => esc_html__('Web Developer', 'lunex-toolkit'),
                        'style1_member_name' => esc_html__('Nyxelle Daxel', 'lunex-toolkit'),
                        'style1_social_profiles' => [
                            [
                                'style1_social_icon' => ['value' => 'ri-facebook-fill', 'library' => 'ri'],
                                'style1_social_link' => ['url' => '#', 'is_external' => true, 'nofollow' => false],
                    ...
                    [
                        ...
                        'style1_member_position' => esc_html__('Web Designer', 'lunex-toolkit'),
                        'style1_member_name' => esc_html__('Serenya Fenrir', 'lunex-toolkit'),
                        'style1_social_profiles' => [
                            [
                                'style1_social_icon' => ['value' => 'ri-facebook-fill', 'library' => 'ri'],
                                'style1_social_link' => ['url' => '#', 'is_external' => true, 'nofollow' => false],
 ...
 // Style 1 Position
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Hover Effects', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style1',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Overlay Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Active Content Background', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    $widgets_manager->register(new lunex_team_card());