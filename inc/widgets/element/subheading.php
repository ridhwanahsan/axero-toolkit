<?php
    ...
    class lunex_subheading extends Widget_Base
    {
        ...
        {
            return __('Sub Heading', 'lunex-toolkit');
        }
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Title Style 2', 'lunex-toolkit'),
                'tab'   => Controls_Manager::TAB_CONTENT,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Title Text', 'lunex-toolkit'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Sub Heading', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Title Style 4', 'lunex-toolkit'),
                'tab'   => Controls_Manager::TAB_CONTENT,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Title Text', 'lunex-toolkit'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('ABOUT US', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'style4_image',
            [
                'label' => esc_html__('Right Arrow Image', 'lunex-toolkit'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Title Style 5', 'lunex-toolkit'),
                'tab'   => Controls_Manager::TAB_CONTENT,
                'condition' => [
        ...
        $this->add_control(
            'style5_switch_sides',
            [
                'label' => esc_html__('Switch Image Side', 'lunex-toolkit'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Right', 'lunex-toolkit'),
                'label_off' => esc_html__('Left', 'lunex-toolkit'),
                'return_value' => 'yes',
                'default' => 'no',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Sub-title Before', 'lunex-toolkit'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->start_controls_section(
            'style4_text_style',
            [
                'label' => esc_html__('Style 4 Text', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style4',
                ],
        ...
        $this->start_controls_section(
            'style5_text_style',
            [
                'label' => esc_html__('Style 5 Text', 'lunex-toolkit'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style5',
                ],
                ...
                <div class="about_us_title d-inline-block" data-cue="slideInUp">
                    <span class="d-flex align-items-center text-uppercase">
                        ...
                        <?php if (!empty($settings['style4_image']['url'])) : ?>
                            <img src="<?php echo esc_url($settings['style4_image']['url']); ?>" alt="<?php echo esc_attr__('Right arrow', 'lunex-toolkit'); ?>">
                        <?php endif; ?>
                    </span>
                </div>
            ...
            <div class="section_title position-relative style_three text_animation  <?php echo esc_attr($settings['style5_switch_sides'] === 'yes' ? 'right_side' : ''); ?>">
                <div class="title position-relative d-inline-block">
                    ...
                    <?php if (!empty($settings['style5_image']['url'])) : ?>
                        <img src="<?php echo esc_url($settings['style5_image']['url']); ?>" alt="<?php echo esc_attr__('Vector image', 'lunex-toolkit'); ?>">
                    <?php endif; ?>
                </div>
            </div>          
    ...
    $widgets_manager->register(new lunex_subheading());
