<?php
    ...
    class lunex_news_form extends Widget_Base
    {

        public function get_name()
        {
            return 'lunex_news_form';
        }

        public function get_title()
        {
            return __('News Form', 'lunex-toolkit');
        }
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => '',
                'description' => esc_html__('Enter the form shortcode from your preferred form plugin (e.g. Contact Form 7, WPForms)', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Form Button Style', 'lunex-toolkit'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Input Border', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style1',
                ],
   ...
   <footer class="creative-agency-footer-area">
    ...
    $widgets_manager->register(new lunex_news_form());