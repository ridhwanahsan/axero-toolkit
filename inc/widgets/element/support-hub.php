<?php
    ...
    class axero_support_hub extends Widget_Base
    {

        public function get_name()
        {
            return 'axero_support_hub';
        }

        public function get_title()
        {
            return __('Support Hub', 'axero-toolkit');
        }
        ...
        protected function register_controls_section()
        {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'     => esc_html__('Via Chat', 'axero-toolkit'),
                    'label_block' => true,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'     => esc_html__('Instant solutions at your fingertips.', 'axero-toolkit'),
                    'label_block' => true,
                ]
            );
        ...
        protected function style_tab_content()
        {
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 1 Box', 'axero-toolkit'),
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 1 Icon', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style1',
                    ],
            ...
            $this->add_responsive_control(
                'style1_icon_width',
                [
                    'label'     => esc_html__('Icon Width', 'axero-toolkit'),
                    'type'      => Controls_Manager::SLIDER,
                    'range'     => [
                        'px' => [
                            'min' => 30,
            ...
            $this->add_responsive_control(
                'style1_icon_height',
                [
                    'label'     => esc_html__('Icon Height', 'axero-toolkit'),
                    'type'      => Controls_Manager::SLIDER,
                    'range'     => [
                        'px' => [
                            'min' => 30,
            ...
            $this->add_control(
                'style1_icon_radius',
                [
                    'label'      => esc_html__('Icon Border Radius', 'axero-toolkit'),
                    'type'       => Controls_Manager::SLIDER,
                    'size_units' => ['px', '%'],
                    'range'      => [
                        'px' => [
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 1 Description', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style1',
                    ],
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Style 1 Button', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style1',
                    ],
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Button Hover', 'axero-toolkit'),
...
<?php if (! empty($settings['style1_link']['url'])):
    ...
    $widgets_manager->register(new axero_support_hub());