<?php
    ...
    class Lunex_side_bar extends Widget_Base
    {

        public function get_name()
        {
            return 'Lunex_side_bar';
        }

        public function get_title()
        {
            return __('Career SideBar', 'lunex-toolkit');
        }
        ...
        protected function register_controls_section()
        {
            ...
            $this->add_control(
                'experience_label',
                [
                    'label'       => esc_html__('Experience Label', 'lunex-toolkit'),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__('Experience', 'lunex-toolkit'),
                    'placeholder' => esc_html__('Enter experience label', 'lunex-toolkit'),
                ]
            );
            ...
            $this->add_control(
                'working_hours_label',
                [
                    'label'       => esc_html__('Working Hours Label', 'lunex-toolkit'),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__('Working Hours', 'lunex-toolkit'),
                    'placeholder' => esc_html__('Enter working hours label', 'lunex-toolkit'),
                ]
            );
            ...
            $this->add_control(
                'working_days_label',
                [
                    'label'       => esc_html__('Working Days Label', 'lunex-toolkit'),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__('Working Days', 'lunex-toolkit'),
                    'placeholder' => esc_html__('Enter working days label', 'lunex-toolkit'),
                ]
            );
            ...
            $this->add_control(
                'salary_label',
                [
                    'label'       => esc_html__('Salary Label', 'lunex-toolkit'),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__('Salary', 'lunex-toolkit'),
                    'placeholder' => esc_html__('Enter salary label', 'lunex-toolkit'),
                ]
            );
            ...
            $this->add_control(
                'vacancy_label',
                [
                    'label'       => esc_html__('Vacancy Label', 'lunex-toolkit'),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__('Vacancy', 'lunex-toolkit'),
                    'placeholder' => esc_html__('Enter vacancy label', 'lunex-toolkit'),
                ]
            );
            ...
            $this->add_control(
                'deadline_label',
                [
                    'label'       => esc_html__('Deadline Label', 'lunex-toolkit'),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__('Deadline', 'lunex-toolkit'),
                    'placeholder' => esc_html__('Enter deadline label', 'lunex-toolkit'),
                ]
            );
            ...
            $this->add_control(
                'apply_now_label',
                [
                    'label'       => esc_html__('Apply Now Label', 'lunex-toolkit'),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__('Apply Now', 'lunex-toolkit'),
                    'placeholder' => esc_html__('Enter apply now label', 'lunex-toolkit'),
                ]
            );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Info Box Style', 'lunex-toolkit'),
        ...
        $this->add_control(
            'value_color',
            [
                'label' => esc_html__('Value Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Value Typography', 'lunex-toolkit'),
        ...
        $this->add_control(
            'item_spacing',
            [
                'label' => esc_html__('Item Spacing', 'lunex-toolkit'),
    ...
    $widgets_manager->register(new Lunex_side_bar());