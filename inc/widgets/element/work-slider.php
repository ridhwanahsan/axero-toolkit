<?php
    ...
    class axero_work_slider extends Widget_Base
    {

        public function get_name()
        {
            return 'axero_work_slider';
        }

        public function get_title()
        {
            return __('Work Slider', 'axero-toolkit');
        }
        ...
        protected function register_controls_section()
        {
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Slider Content', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_CONTENT,
                    'condition' => [
                        'style_selection' => 'style1',
                    ],
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default'     => esc_html__('Discovery phase', 'axero-toolkit'),
                    'label_block' => true,
                ]
            );
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default'     => esc_html__('In this initial phase, we dive deep into understanding your business, goals, and target audience.', 'axero-toolkit'),
                    'label_block' => true,
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'     => [
                        [
                            'style1_slide_title'       => esc_html__('Discovery phase', 'axero-toolkit'),
                            'style1_slide_description' => esc_html__('In this initial phase, we dive deep into understanding your business, goals, and target audience.', 'axero-toolkit'),
                        ],
                    ],
    ...
    $widgets_manager->register(new axero_work_slider());