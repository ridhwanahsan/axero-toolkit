<?php
    ...
    class axero_future_service extends Widget_Base
    {

        public function get_name()
        {
            return 'axero_future_service';
        }

        public function get_title()
        {
            return __('Future Service', 'axero-toolkit');
        }
        ...
        protected function register_controls_section()
        {
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => esc_html__('Service Items', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_CONTENT,
                    'condition' => [
            ...
            $this->add_control(
                'service_items',
                [
                    'label'       => esc_html__('Services', 'axero-toolkit'),
                    'type'        => Controls_Manager::REPEATER,
                    'fields'      => $repeater->get_controls(),
                    'default'     => [
                        [
                            'service_title'       => esc_html__('Smart strategy', 'axero-toolkit'),
                            'service_description' => esc_html__('We craft data-driven strategies tailored to your business goals, ensuring efficiency & impactful results.', 'axero-toolkit'),
                        ],
                        [
                            'service_title'       => esc_html__('Seamless execution', 'axero-toolkit'),
                            'service_description' => esc_html__('Our expert team transforms ideas into reality with precision, delivering high-quality solutions on time.', 'axero-toolkit'),
                        ],
                    ],
            ...
            $repeater->add_control(
                'service_icon_hover',
                [
                    'label'   => esc_html__('Icon Hover', 'axero-toolkit'),
                    'type'    => Controls_Manager::MEDIA,
                    'default' => [
                        'url' => \Elementor\Utils::get_placeholder_image_src(),
                    ],
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'     => [
                        [
                            'service_title'       => esc_html__('Ideation phase', 'axero-toolkit'),
                            'service_description' => esc_html__('We begin by brainstorming and refining creative ideas that align with your brand vision. This phase sets the foundation for a strategic and impactful execution.', 'axero-toolkit'),
                        ],
                    ],
                    'title_field' => '{{{ service_title }}}',
                ]
            ...
            $repeater->add_control(
                ...
                [
                    'label'       => esc_html__('Title', 'axero-toolkit'),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__('Grow Your Business', 'axero-toolkit'),
                    'label_block' => true,
                ]
            );
            ...
            $repeater->add_control(
                'play_now_image',
                [
                    'label'       => esc_html__('Play Now Image', 'axero-toolkit'),
                    'type'        => Controls_Manager::MEDIA,
                    'default'     => [
                        'url' => \Elementor\Utils::get_placeholder_image_src(),
                    ],
                    'description' => esc_html__('Upload the play button image that appears on video thumbnails', 'axero-toolkit'),
                    'condition'   => [
                        'video_url[url]!' => '',
                    ],
                ]
            ...
            $repeater->add_control(
                'feature_image',
                [
                    'label'   => esc_html__('Feature Image', 'axero-toolkit'),
                    'type'    => Controls_Manager::MEDIA,
                    'default' => [
                        'url' => \Elementor\Utils::get_placeholder_image_src(),
                    ],
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'raw'             => esc_html__('Note: If you don\'t need the video play button, simply leave the Video URL field empty.', 'axero-toolkit'),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'     => [
                        [
                            'feature_title'  => esc_html__('Grow Your Business', 'axero-toolkit'),
                            'feature_number' => '01',
                        ],
                    ],
        ...
        protected function style_tab_content()
        {
            ...
            $this->start_controls_section(
                'feature_item_style',
                [
                    'label'     => esc_html__('Feature Item Style', 'axero-toolkit'),
            ...
            $this->add_control(
                'circle_color',
                [
                    'label'     => esc_html__('Circle Color', 'axero-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->start_controls_section(
                'style_tab_2',
                [
                    'label'     => esc_html__('Style Tab 2', 'axero-toolkit'),
                    'tab'       => Controls_Manager::TAB_STYLE,
                    'condition' => [
                        'style_selection' => 'style2',
                    ],
            ...
            $this->add_control(
                'none_hover_color',
                [
                    'label'     => esc_html__('None Hover Color', 'axero-toolkit'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
...
<?php if (! empty($item['video_url']['url'])): ?>
                                <a href="<?php echo esc_url($item['video_url']['url']); ?>" class="video_btn popup_video popup-youtube">
                                    <img src="<?php echo esc_url($item['play_now_image']['url']); ?>" alt="<?php echo esc_attr__('Play Now', 'axero-toolkit'); ?>">
    ...
    $widgets_manager->register(new axero_future_service());