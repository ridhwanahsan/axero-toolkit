<?php
    ...
    class lunex_bottom_top extends Widget_Base
    {

        public function get_name()
        {
            return 'lunex_bottom_top';
        }

        public function get_title()
        {
            return __('Back to top', 'lunex-toolkit');
        }
        ...
        $this->start_controls_section(
            'style1_section',
            [
                'label' => esc_html__('Style 1 Settings', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_CONTENT,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Back to top', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
...
<?php
    ...
    $widgets_manager->register(new lunex_bottom_top());