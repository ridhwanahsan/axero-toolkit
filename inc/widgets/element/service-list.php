<?php
    ...
    class lunex_service_list extends Widget_Base
    {

        public function get_name()
        {
            return 'lunex_service_list';
        }

        public function get_title()
        {
            return __('Service List', 'lunex-toolkit');
        }
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__('Digital Advertising', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid unt ut labore et dolore magna.', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            'services_list',
            [
                'label' => esc_html__('Services List', 'lunex-toolkit'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'service_title' => esc_html__('Digital Advertising', 'lunex-toolkit'),
                        'service_description' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid unt ut labore et dolore magna.', 'lunex-toolkit'),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Button', 'lunex-toolkit'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
    ...
    $widgets_manager->register(new lunex_service_list());