<?php
    ...
    class lunex_text_animate extends Widget_Base
    {
        ...
        {
            return __('Text Animate', 'lunex-toolkit');
        }
        ...
        $this->add_control(
            'title_number',
            [
                'label'       => esc_html__('Title Number', 'lunex-toolkit'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('01', 'lunex-toolkit'),
                'label_block' => true,
                 'condition' => [
                    'style_selection' => 'style1',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Introduction', 'lunex-toolkit'),
                'label_block' => true,
                 'condition' => [
                    'style_selection' => 'style1',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('We specialize in crafting innovative brand experiences that seamlessly blend creativity and strategy. Our team is dedicated to inspiring audiences, driving engagement, and fostering growth through tailored, impactful solutions. 🚀', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Description', 'lunex-toolkit'),
                'type'        => Controls_Manager::TEXTAREA,
                'default'     => esc_html__('wasn’t just about visuals—it was a powerful force for business transformation.', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Additional Text 1', 'lunex-toolkit'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('  Our California-based', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Additional Text 2', 'lunex-toolkit'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('creative agency', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Additional Text 3', 'lunex-toolkit'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('is known for combining creativity & expertise to deliver outstanding UI/UX designs with', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Additional Text 4', 'lunex-toolkit'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('innovative', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Additional Text 5', 'lunex-toolkit'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('ideas and user-friendly functionality.', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Description (Style 2)', 'lunex-toolkit'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Span Text Color', 'lunex-toolkit'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__('Span Typography', 'lunex-toolkit'),
...
$widgets_manager->register(new lunex_text_animate());
