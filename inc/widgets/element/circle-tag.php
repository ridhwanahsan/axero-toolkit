<?php
    ...
    class lunex_circle_tag extends Widget_Base
    {

        public function get_name()
        {
            return 'lunex_circle_tag';
        }

        public function get_title()
        {
            return __('Circle Tag ', 'lunex-toolkit');
        }
        ...
        $this->add_control(
            'link_url',
            [
                'label' => esc_html__('Link URL', 'lunex-toolkit'),
        ...
        $this->add_control(
            'icon_image',
            [
                'label' => esc_html__('Icon Image', 'lunex-toolkit'),
        ...
        $this->add_control(
            'hover_icon_image',
            [
                'label' => esc_html__('Hover Icon Image', 'lunex-toolkit'),
                'type' => Controls_Manager::MEDIA,
                'default' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label'      => esc_html__('Content (Style 2)', 'lunex-toolkit'),
                'tab'        => Controls_Manager::TAB_CONTENT,
                'condition'  => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Lets Chat', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label'      => esc_html__('Content (Style 3)', 'lunex-toolkit'),
                'tab'        => Controls_Manager::TAB_CONTENT,
                'condition'  => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Your Text Here', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'line_off',
            [
                'label'        => esc_html__('Line Off', 'lunex-toolkit'),
        ...
        $this->start_controls_section(
            ...
            [
                'label'      => esc_html__('Content (Style 4)', 'lunex-toolkit'),
                'tab'        => Controls_Manager::TAB_CONTENT,
                'condition'  => [
        ...
        $this->add_control(
            'style4_circle_image',
            [
                'label'       => esc_html__('Circle Image', 'lunex-toolkit'),
                'type'        => Controls_Manager::MEDIA,
                'default'     => [
                    'url' => get_template_directory_uri() . '/assets/images/icons/circle-text.svg',
                ],
                'description' => esc_html__('Upload or select a circular text image', 'lunex-toolkit'),
            ]
        );
        ...
        $this->add_control(
            'style4_arrow_image',
            [
                'label' => esc_html__('Arrow Image', 'lunex-toolkit'),
                'type'  => Controls_Manager::MEDIA,
                'default' => [
        ...
        $this->start_controls_section(
            'style_section',
            [
                'label'      => esc_html__('Style', 'lunex-toolkit'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style 2 bg', 'lunex-toolkit'),
                'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Button Border Color', 'lunex-toolkit'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#000000',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Button Hover Border Color', 'lunex-toolkit'),
                'type' => \Elementor\Controls_Manager::COLOR,
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__('Circle controls', 'lunex-toolkit'),
                'tab'       => \Elementor\Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Button Width', 'lunex-toolkit'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Button Height', 'lunex-toolkit'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Button Margin Top', 'lunex-toolkit'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Button Line Height', 'lunex-toolkit'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'range' => [
                    'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style 4', 'lunex-toolkit'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style4',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Button Inner Background Color', 'lunex-toolkit'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
...
<footer class="marketing-agency-footer-area">
                ...
                <div class="awesome_about_us_content position-relative mx-auto" data-cues="slideInUp" data-group="awesome_about_us_content">
                    <div class="circle_text text-center">
                        <?php if (!empty($settings['style3_image']['url'])): ?>
                            <img src="<?php echo esc_url($settings['style3_image']['url']); ?>" alt="<?php esc_attr_e('Circle Text', 'lunex-toolkit'); ?>">
                        <?php endif; ?>
                  ...
                  <div class="footer-left-side">
                            <div class="d-mdj-flex align-items-center">
                                <a href="<?php echo !empty($settings['style4_link']['url']) ? esc_url($settings['style4_link']['url']) : '#'; ?>" class="link-btn d-inline-block rounded-circle text-center" data-cue="slideInUp" <?php echo !empty($settings['style4_link']['is_external']) ? 'target="_blank"' : ''; ?> <?php echo !empty($settings['style4_link']['nofollow']) ? 'rel="nofollow"' : ''; ?>>
                                    <img src="<?php echo esc_url($settings['style4_circle_image']['url']); ?>" alt="<?php esc_attr_e('Circle Text', 'lunex-toolkit'); ?>">
                                    
                                    <img src="<?php echo esc_url($settings['style4_arrow_image']['url']); ?>" alt="<?php esc_attr_e('Right Top Arrow', 'lunex-toolkit'); ?>">
                                </a>
                            </div>
                            </div>
                         </footer>
    ...
    $widgets_manager->register(new lunex_circle_tag());
