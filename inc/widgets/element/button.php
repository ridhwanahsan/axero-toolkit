<?php
    ...
    class lunex_button extends Widget_Base
    {
        ...
        {
            return __('Button', 'lunex-toolkit');
        }
        ...
        $this->start_controls_section(
            'button_content',
            [
                'label' => esc_html__('Button Content', 'lunex-toolkit'),
                'tab'   => Controls_Manager::TAB_CONTENT,
                     'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('View Services', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Button Content (Style 2)', 'lunex-toolkit'),
                'tab'   => Controls_Manager::TAB_CONTENT,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Text', 'lunex-toolkit'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Start a Project', 'lunex-toolkit'),
                'label_block' => true,
            ]
        );
        ...
        // Button Style Section
         $this->start_controls_section(
            'button_style',
            [
                'label' => esc_html__('Button Styling', 'lunex-toolkit'),
        ...
        $this->start_controls_section(
            'button_style2',
            [
                'label' => esc_html__('Button Styling (Style 2)', 'lunex-toolkit'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style_selection' => 'style2',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__('Border Width', 'lunex-toolkit'),
        ...
        $button_text = !empty($settings['button_text_style2']) ? esc_html($settings['button_text_style2']) : esc_html__('Start a Project', 'lunex-toolkit');
    ...
    $widgets_manager->register(new lunex_button());
